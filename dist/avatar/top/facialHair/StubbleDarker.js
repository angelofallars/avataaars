...
var StubbleDarker = /** @class */ (function (_super) {
    __extends(StubbleDarker, _super);
    function StubbleDarker() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.mask1 = lodash_1.uniqueId('react-mask-');
        _this.path1 = lodash_1.uniqueId('react-path-');
        return _this;
    }
    StubbleDarker.prototype.render = function () {
        var _a = this, mask1 = _a.mask1, path1 = _a.path1;
        return (React.createElement("g", { id: 'Facial-Hair/StubbleDarker', transform: 'translate(49.000000, 72.000000)', fillOpacity: '0.5', fillRule: 'nonzero' },
            ...
            React.createElement("use", { id: 'StubbleDarker', fill: '#331B0C', fillRule: 'evenodd', xlinkHref: '#' + path1 }),
            React.createElement(Colors_1.default, { maskID: mask1 })));
    };
    StubbleDarker.optionValue = 'StubbleDarker';
    return StubbleDarker;
}(React.Component));
exports.default = StubbleDarker;
