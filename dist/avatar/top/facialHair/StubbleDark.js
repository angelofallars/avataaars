...
var StubbleDark = /** @class */ (function (_super) {
    __extends(StubbleDark, _super);
    function StubbleDark() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.mask1 = lodash_1.uniqueId('react-mask-');
        _this.path1 = lodash_1.uniqueId('react-path-');
        return _this;
    }
    StubbleDark.prototype.render = function () {
        var _a = this, mask1 = _a.mask1, path1 = _a.path1;
        return (React.createElement("g", { id: 'Facial-Hair/StubbleDark', transform: 'translate(49.000000, 72.000000)', fillOpacity: '0.4', fillRule: 'nonzero' },
            ...
            React.createElement("use", { id: 'StubbleDark', fill: '#331B0C', fillRule: 'evenodd', xlinkHref: '#' + path1 }),
            React.createElement(Colors_1.default, { maskID: mask1 })));
    };
    StubbleDark.optionValue = 'StubbleDark';
    return StubbleDark;
}(React.Component));
exports.default = StubbleDark;
